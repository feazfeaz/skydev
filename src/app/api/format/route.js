...
export async function GET() {
  const readPath = `E:\\hyu\\storage\\night screen\\13441-247710869_small.mp4`;
  // console.log("readPath: ", readPath);
  console.log("file: ", (await parseFile(readPath)).format.duration);
  const { duration } = await getMetadata(readPath);
